...
<head>
  ...
  <style>
    ...
    /* Chat area */
    .chatArea {
      background: url('https://i.imgur.com/v9R5YI9.png');
...
<body>
  ...
  <div class="controls">
    <input id="contactName" placeholder="Contact name (e.g. Mom)">
  ...
  <div class="iphone" id="chatBox">
    ...
    <div class="header" id="contactHeader">Contact</div>
